...
<head>
  ...
  <title>View Faulty Courses</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View Fault Courses Page</li>
        </ol>
      </nav>
      <!-- Users DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> All courses with <strong>0</strong> for credit units, year or semester
        </div>
        <div class="card-body">
    ...
    <script>
      $(document).ready(function() {
        var pastpapers = $("#coursesTable").DataTable({
          serverSide: true,
          paging: true,
          pageLength: 50,
          lengthMenu: [
